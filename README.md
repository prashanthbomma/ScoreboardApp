...
Scoreboard App used a number of open source projects to work properly:

* [ReactJS](https://reactjs.org/) - JavaScript library for building UI
* [VSCode](https://reactjs.org/) - Popular open source code editor for building modern web apps
* [Babel](https://babeljs.io/) - Babel is a JavaScript compiler that includes the ability to compile JSX into regular JavaScript
